...
{{--                            <td>{{date('d/m/Y H:i:s', strtotime($bloqueio->created_at))}}</td>--}}
                            ...
                            <td>{{$arrDiaSemana[$bloqueio->horario->dia_semana]}}
                                - {{substr($bloqueio->horario->hora_inicio, 0, -3)}}
                                às {{substr($bloqueio->horario->hora_termino, 0, -3)}}</td>
                            ...
                            <td><a href="{{ route('bloqueios.edit', $bloqueio->id) }}" class="btn btn-primary btn-sm">Editar</a>
                            </td>
                            <td>
