                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('horarios.update', $horario->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="numero_vagas" type="text" class="form-control @error('numero_vagas') is-invalid @enderror" name="numero_vagas" value="{{ $horario->numero_vagas }}" required autocomplete="numero_vagas">
                            @error('numero_vagas')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group">
                            ...
                            <input id="numero_vagas_espera" type="text" class="form-control @error('numero_vagas_espera') is-invalid @enderror" name="numero_vagas_espera" value="{{ $horario->numero_vagas_espera }}" required autocomplete="numero_vagas_espera">
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $participantes = $participanteController->loadParticipantes($horario->id);
                            @endphp
