                ...
                <div class="card-body">
                    <form method="post" action="{{ route('orientacoes.update', $orientacao->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="descricao" type="text" class="form-control @error('descricao') is-invalid @enderror maiuscula" name="descricao" value="{{ $orientacao->descricao }}" required autocomplete="descricao" autofocus>
                            @error('descricao')
