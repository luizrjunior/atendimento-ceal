...
@section('javascript')
<script>
    top.urlListaLocals = "{{ url('locals') }}";
    top.urlAtivarDesativarLocal = "{{ url('locals/ativar-desativar-local') }}";
</script>
<script type="text/javascript" src="{{ asset('/js/cadastros/locals/index-local.js') }}"></script>
@endsection
...
<div class="container">
    <div class="card uper">
        ...
        <div class="card-header">
            Lista de Locais
            <a href="{{ url('locals/create') }}" class="float-right">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('locals.edit', $local->id) }}" class="btn btn-primary btn-sm">Editar</a></td>
                        <td>
                            @if ($local->situacao == 1)
