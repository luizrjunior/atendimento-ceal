                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('motivos.update', $motivo->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="descricao" type="text" class="form-control @error('descricao') is-invalid @enderror" name="descricao" value="{{ $motivo->descricao }}" required autocomplete="descricao" autofocus>
                            @error('descricao')
