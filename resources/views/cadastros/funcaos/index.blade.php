...
@section('javascript')
<script>
    top.urlListaFuncaos = "{{ url('funcaos') }}";
    top.urlAtivarDesativarFuncao = "{{ url('funcaos/ativar-desativar-funcao') }}";
</script>
<script type="text/javascript" src="{{ asset('/js/cadastros/funcaos/index-funcao.js') }}"></script>
@endsection
...
<div class="container">
    <div class="card uper">
        ...
        <div class="card-header">
            Lista de Funções
            <a href="{{ url('funcaos/create') }}" class="float-right">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('funcaos.edit', $funcao->id) }}" class="btn btn-primary btn-sm">Editar</a></td>
                        <td>
