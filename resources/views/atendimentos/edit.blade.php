                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('atendimentos.update', $atendimento->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('atendente_id') is-invalid @enderror" id="atendente_id" name="atendente_id" required disabled>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('atendimentos.store-atendimento-has-orientacao') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3">{{ $atendimento->observacoes }}</textarea>
                          </div>
