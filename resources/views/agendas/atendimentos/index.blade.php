...
<script type="text/javascript" src="{{ asset('/js/agendas/agendamentos/index-agendamento.js') }}"></script>
@endsection
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$agendamento->horario->local->numero}} - {{$agendamento->horario->local->nome}}</td>
                        <td>
