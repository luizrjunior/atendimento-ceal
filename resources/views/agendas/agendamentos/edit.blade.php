...
<script>
    ...
    top.valorSelectAtividade = '{{ $agendamento->horario->atividade->id }}';
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('agendamentos.update', $agendamento->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="numero_vagas_presencial" type="text" class="form-control @error('numero_vagas_presencial') is-invalid @enderror" name="numero_vagas_presencial" value="{{ $agendamento->numero_vagas_presencial }}" required autocomplete="numero_vagas_presencial">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <a href="{{ url('agendamentos/create') }}" class="btn btn-secondary">
                                Novo
                            </a>
                        </div>
                    </form>
