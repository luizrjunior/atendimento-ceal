        ...
        <div class="col-md-8">
            ...
            <div id="divAtendimento" class="card uper">
                ...
                <div class="card-body">
                    ...
                    <form id="formAtendimentosUpdate" method="post" action="{{ route('atendimentos-admin.update', $atendimento->id) }}">
                        @method('PATCH')
                        @csrf
                        ...
                        <div id="divFormaAtendimento" class="form-group {{ $errors->has('forma') ? 'has-error' : '' }}">
                        ...
                        <div id="divAtendente" class="form-group {{ $errors->has('atendente_id') ? 'has-error' : '' }}">
                            <label for="atendente_id">Atendente Responsável</label>
                            <select class="form-control @error('atendente_id') is-invalid @enderror" id="atendente_id" name="atendente_id" required>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('atendimentos-admin.salvar-observacoes-atendimento') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control rounded-0" id="observacoes" name="observacoes" rows="5">{{$atendimento->observacoes}}</textarea>
                          </div>
