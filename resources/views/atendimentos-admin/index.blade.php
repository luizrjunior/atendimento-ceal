                ...
                <form method="post" action="{{ route('atendimentos-admin.index') }}">
                    ...
                    <div class="card uper">
                        <div class="card-header">
                            ...
                            <a href="{{ url('atendimentos-admin/create') }}" class="float-right">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="data_inicio_psq">Período de</label>
                                    <input type='text' class="form-control" id="data_inicio_psq" name="data_inicio_psq"
                                           value="{{ $data_inicio_psq }}" autocomplete="data_inicio_psq">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="data_termino_psq">Até</label>
                                    <input type='text' class="form-control" id="data_termino_psq"
                                           name="data_termino_psq"
                                           value="{{ $data_termino_psq }}" autocomplete="data_termino_psq">
                                </div>
                            </div>
                            ...
                            <div class="card uper">
                                <div class="card-header">Lista dos Atendimentos</div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($atendimentos as $atendimento)
                                            <tr>
                                                ...
                                                <td>{{$arrDiaSemana[$atendimento->diaSemana]}}
                                                    - {{substr($atendimento->horaInicio, 0, -3)}}
                                                    às {{substr($atendimento->horaTermino, 0, -3)}}</td>
                                            ...
                                            <span class="badge badge-{{$bgColor[$atendimento->situacao]}}"
                                                  data-toggle="tooltip"
                                                  title="{{$arrSituacao[$atendimento->situacao]}}">
                                                {{$arrSituacao[$atendimento->situacao]}}
                                            </span>
                                                </td>
                                                <td>
                                                    <a href="{{ route('atendimentos-admin.edit', $atendimento->id) }}"
