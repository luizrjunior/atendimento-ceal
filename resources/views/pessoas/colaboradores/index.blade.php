...
@section('javascript')
<script>
    top.urlListaColaboradors = "{{ url('colaboradors') }}";
    top.urlAtivarDesativarColaborador = "{{ url('colaboradors/ativar-desativar-colaborador') }}";
</script>
<script type="text/javascript" src="{{ asset('/js/cadastros/colaboradors/index-colaborador.js') }}"></script>
@endsection
...
<div class="container">
    <div class="card uper">
        ...
        <div class="card-header">
            ...
            <a href="{{ url('colaboradors/create') }}" class="float-right">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('colaboradors.edit', $colaborador->id) }}" class="btn btn-primary btn-sm">Editar</a></td>
                        <td>
